...
function ErrorBanner({ message, onDismiss }: { message: string; onDismiss: () => void }) { return <div className="error-banner"><span className="error-symbol">!</span><div><strong>We hit a snag</strong><p>{message}</p></div><button onClick={onDismiss}>×</button></div>; }
